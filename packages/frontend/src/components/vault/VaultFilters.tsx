...
export function VaultFilters({
  ...
  return (
    /* 📱 ADAPTIVE FILTER WRAPPER: Stacks search input bars and scroll badges cleanly across layouts */
    <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm flex flex-col lg:flex-row gap-4 items-center justify-between">
      ...
      {/* 📱 HORIZONTAL BADGE SWIPING: Prevents layout alignment breaks on tight phones screens */}
