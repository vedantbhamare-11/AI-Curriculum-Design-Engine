  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-6 transition-all duration-300">
      ...
      <button
        ...
        onClick={onRefresh}
        disabled={isSyncing}
        className="h-11 px-5 bg-white border border-slate-200 text-slate-700 hover:border-slate-300 rounded-xl flex items-center justify-center gap-2 text-xs font-black uppercase tracking-wider transition-all shadow-sm active:scale-95 disabled:opacity-50 cursor-pointer shrink-0 self-start sm:self-auto"
